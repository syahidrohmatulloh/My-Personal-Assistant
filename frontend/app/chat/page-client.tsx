...
export function ChatHomePageClient({ initialAssistantName = "" }: { initialAssistantName?: string }) {
  ...
  useEffect(() => {
    ...
    document.cookie = `app-assistant-name=${encodeURIComponent(
      assistantName.trim(),
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0 flex-1">
                <textarea
                  ...
                  rows={1}
                  placeholder={`Ask ${assistantName || "your assistant"} anything`}
